...
//        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=BookStore;Trusted_Connection=True;MultipleActiveResultSets=True; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A643D33D5A");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207F04137F4");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B2D6D11C5");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF9307CD98");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36CF5A4A608");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB308DCA23");
