...
namespace Lab9.Areas.Admins.Controllers
{
    ...
    public class PublishersController : Controller
    {
        ...
        // GET: Admins/Publishers
        public async Task<IActionResult> Index()
        {
            return View(await _context.Publishers.ToListAsync());
        }

        // GET: Admins/Publishers/Details/5
        ...
        // GET: Admins/Publishers/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admins/Publishers/Create
        ...
        // GET: Admins/Publishers/Delete/5
        ...
        // POST: Admins/Publishers/Delete/5
